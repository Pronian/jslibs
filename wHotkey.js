...
wHotkey.matchHotkey = (buffer, hotkey) => {
...
wHotkey.normalizeHotkey = (hotkey) => hotkey.split(/ +/g).map(
  (part) => {
...
const createKeyDownListener = (listeners, debounceTime) => {
  ...
  return (event) => {
    ...
    listeners.forEach((listener) => {
      if (wHotkey.matchHotkey(buffer, listener.hotkey)) {
